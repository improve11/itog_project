...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        toolbar = tk.Frame(bg='#C0C0C0', bd=2, )
        toolbar.pack(side=tk.TOP, fill=tk.X)
        self.add_img = tk.PhotoImage(file='./add.png')
        # Создание кнопки
        btn_open_dialog = tk.Button(toolbar, bg='#C0C0C0', bd=0,
                                    image=self.add_img,
        ...
        # Создание кнопки
        btn_upd_open_dialog = tk.Button(toolbar, bg='#C0C0C0', bd=0,
                                        image=self.upd_img,
        ...
        # Создание кнопки
        btn_del_open_dialog = tk.Button(toolbar, bg='#C0C0C0', bd=0,
                                        image=self.del_img,
        ...
        # Создание кнопки
        btn_search_dialog = tk.Button(toolbar, bg='#C0C0C0', bd=0,
        ...
        # Создание кнопки
        btn_refresh = tk.Button(toolbar, bg='#C0C0C0', bd=0,
